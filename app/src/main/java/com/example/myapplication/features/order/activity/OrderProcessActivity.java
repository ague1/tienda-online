package com.example.myapplication.features.order.activity;
...
import com.example.myapplication.features.order.usecase.ListenOrderUseCase;
...
public class OrderProcessActivity extends AppCompatActivity {
    ...
    private void listenOrder(String orderId) {
        listenOrderUseCase.execute(orderId,(snapshot,error)->{
