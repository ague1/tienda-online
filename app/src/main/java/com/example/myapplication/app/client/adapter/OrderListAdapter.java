...
import com.example.myapplication.app.delivery.activity.DeliveryOrderActivity;
import com.example.myapplication.app.client.activity.OrderProcessActivity;
...
public class OrderListAdapter extends RecyclerView.Adapter<OrderListAdapter.ViewHolder> {
    ...
    public OrderListAdapter(Context context, List<DocumentSnapshot> orders) {
